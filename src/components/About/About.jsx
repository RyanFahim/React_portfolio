        ...
        <section className="about section" id="about">
            ...
            <div className="about__container container grid">
                ...
                <div className="about__data">
                    ...
                    I am a professional software developer having experience over 2 years. I have built my skills on various fields gaining expertise over React JS, JavaScript, HTML & CSS. <br /> Passionate about <span style={{fontWeight:"bolder"}}>Web Development</span> & highly motivated to solve problems. <br /> <br />
